...
public class PrimeGeneratorTester {
    ...
    @Test
    public final void whenInputsAreVeryLarge(){
        PrimeGenerator generator = new PrimeGenerator();
        Integer[] primesArray = {100003	, 100019	, 100043	, 100049	, 100057	, 100069	, 100103	, 100109
        ...
        List<Integer> primes = Arrays.asList(primesArray);
        Assert.assertEquals(primes, generator.generate(100000,104730));
    }

    @Test
    public final void whenInputsAreTheSameAndPrime(){
        PrimeGenerator generator = new PrimeGenerator();
        Integer[] primesArray = {7919};
        List<Integer> primes = Arrays.asList(primesArray);
        Assert.assertEquals(primes, generator.generate(7919,7919));
    }
}
